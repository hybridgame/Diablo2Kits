...
### D2 바바리안 키트
    ...
    이로 인해 외부세력의 간섭에서 자유로울 수 있었고 서부의 왕국들은 이들이 소유한 부유한 문화와 정신적인 역사를 믿으면서 별명을 '바바리안(바바리안s)'이라고 불렀다. 한편, 아리앗 산으로 둘러싸인 그들의 영토는 외부의 접근을 절대 허락치 않으며 바바리안의 전사들은 외부의 침입에 민첩하게 대처한 탓에 진정으로 바바리안의 능력을 하는 사람은 극히 드물었다.
    ...
    - 배쉬: 맞은 적은 추가 피해와 브레스 웨폰에 내성굴림하여 실패할 경우 뒤로 약간 밀려난다.
    01레벨: +1 피해, +2 내성굴림
    04레벨: +2 피해, +1 내성굴림
    08레벨: +3 피해,  0 내성굴림
    12레벨: +4 피해, -1 내성굴림

    - 스턴: 맞은 적은 브레스 웨폰에 내성굴림하여 실패할 경우 6초간 기절한다.
    08레벨: +1 내성굴림
    12레벨:  0 내성굴림
    16레벨: -1 내성굴림
    20레벨: -2 내성굴림

    - 컨센트레이션: 공격력과 방어력이 상승한다.
    12레벨: +1 AC, +2 THAC0, 피해
    16레벨: +2 AC, +3 THAC0, 피해
    20레벨: +3 AC, +4 THAC0, 피해
    24레벨: +4 AC, +5 THAC0, 피해

    - 버서크: 일반 공격에 마법 피해가 추가된다.
    20레벨: +3 THAC0, +6  피해
    24레벨: +4 THAC0, +8  피해
    28레벨: +5 THAC0, +10 피해
    32레벨: +6 THAC0, +12 피해

    - 휠윈드: 일반 공격이 주변의 적까지 공격한다.
    20레벨: +3 THAC0, +4-8  피해
    24레벨: +4 THAC0, +5-10 피해
    28레벨: +5 THAC0, +6-12 피해
    32레벨: +6 THAC0, +7-14 피해
...
### D2 드루이드 키트
    ...
    특징:
    - D2 드루이드의 애니메이션은 웨어울프로 변한다.

    장점:

    - 드루이드가 사용할 수 있는 무기와 스타일을 전문화 할 수 있다.
    - 공회가 1회 추가된다.
    ...
    - 파이어 클로: 직접공격에 불 피해가 추가된다.
    09레벨: +2
    12레벨: +4
    15레벨: +6
    18레벨: +8

    - 레이비즈: 직접공격에 독 피해가 추가된다.
    12레벨: 3초간 초당 1
    15레벨: 5초간 초당 1
    18레벨: 4초간 초당 2
    21레벨: 5초간 초당 2

    - 퓨리: 공회가 1회 추가되고 직접공격에 피해가 추가된다.
    15레벨: THAC0, 피해 +2
    18레벨: THAC0, 피해 +4
    21레벨: THAC0, 피해 +6
    24레벨: THAC0, 피해 +8
...
### D2 팔라딘 키트
    ...
    그들 중 살아 돌아온 유일한 사제가 척박한 기후와 부족한 물자, 도적떼의 습격, 위험한 몬스터들의 출현에 대해서 상세하게 교회에 보고했고 이 어려운 임무를 성공시키기 위해 교회에서는 신성 기사인 '팔라딘(팔라딘)'을 훈련시켜서 사제들과 동행해 그들을 보호하도록 지시했다. 그리고 이 '세계의 수호자'들은 사제를 지키는 임무보다는 오히려 원주민들을 개종 시키는데 더욱 큰 몫을 해냈다.
    ...
    - 하이어빌로 내구성, 홀리쉴드, 파나티시즘, 컨빅션, 셀베이션을 선택할 수 있다.
    ...
    - 홀리 파이어: 직접공격에 불 피해가 2추가되고 주변적에 1라운드 마다 불 피해를 준다.
    04레벨: 1-2
    08레벨: 2-3
    12레벨: 3-4
    15레벨: 4-5

    - 홀리 프리즈: 직접공격에 마법 피해가 2추가되고 주변적의 이동속도를 1 낮추며, 주변적에 1라운드 마다 마법 피해를 준다.
    12레벨: 2-3
    15레벨: 3-4
    18레벨: 4-5
    21레벨: 5-6

    - 홀리 쇼크: 직접공격에 전기 피해가 1D7 추가되고 주변적에 1라운드 마다 전기 피해를 준다.
    15레벨: 1-7
    18레벨: 1-10
    21레벨: 1-13
    24레벨: 1-16
    ...
    - 컨센트레이션: 직접공격에 피해가 추가된다.
    12레벨: +6
    15레벨: +7
    18레벨: +8
    21레벨: +9

    - 파나티시즘: 공회가 1회 추가되고 직접공격에 피해가 추가된다.
    18레벨: THAC0 +1, 피해 +2
    21레벨: THAC0 +2, 피해 +4
    24레벨: THAC0 +3, 피해 +6
    27레벨: THAC0 +4, 피해 +8

    - 컨빅션: 주변적의 AC와 원소저항을 낮춘다.
    18레벨: 원소저항 -15%, AC -2
    21레벨: 원소저항 -30%, AC -4
    24레벨: 원소저항 -45%, AC -6
    27레벨: 원소저항 -60%, AC -8
